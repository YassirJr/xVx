...
export function getEmployeePointingCard(employee, profileImg, lastRow) {
  ...
  return `<div class="${
    ...
    <div class="grid grid-cols-4 gap-0 z-10 relative">
      <div class="col-span-2 text-start tracking-widest text-[5px] mb-2" style="font-weight: 700">BADGE DE POINTAGE</div>
