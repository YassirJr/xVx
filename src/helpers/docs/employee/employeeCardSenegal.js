...
export function getEmployeeCardSenegal(employee, company, profileImg, lastRow) {
  const { firstname, lastname, uid, birth_date, cin, type, mission } = employee
  ...
  return `<div class="${
    ...
    <div class="grid grid-cols-4 gap-0 z-10 relative">
      <div class="col-span-2 tracking-widest text-[5px]" style="font-weight: 700">CARTE DE TRAVAIL</div>
      ...
      <div class="col-span-1 text-end">
        <div class="text-[4px] text-end">
          <div>CSS:${type.cnss_affiliation ?? ''}</div>
        </div>
      </div>
