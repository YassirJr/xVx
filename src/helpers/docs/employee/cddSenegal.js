...
export function getCddSenegal(employee, company, lastIndex) {
  const {
    firstname,
    lastname,
    birth_date,
  ...
  return `<div class="times-roman w-[406.46px] bg-white text-[9px]">
    <div class="h-[591.4175px] p-2">
      <h1 class="text-center font-bold text-sm">Contrat de travail à durée déterminée</h1>
      <p class="mb-2">Entre les soussignés,</p>
      <p>
        La société ${company.name}, dont le siège se trouve à ${company.address} représentée
        aux fins des présentés par Monsieur Geraldres Karel Maria Van Oers, en qualité de Gérant, ci-après
        dénommé l’« Employeur »
      </p>
      ...
      <p>
        Par la présente, l’Employeur embauche L’Employé pour un contrat de travail à durée déterminée allant
        du ${contract_date} au ${end_contract_date}.
      </p>
      ...
      <p>
        L’Employé exécutera ses fonctions à  ${company.name}, dans la Région de ${
          departure.label
        }. L’employé accepte par
        avance d’être déplacé temporairement ou muté dans un autre établissement de l’entreprise. Dans ce
        cas, l’employeur devra informer le travailleur et lui fournir les moyens nécessaires et garantir les
      ...
      <p>La durée hebdomadaire de travail est de quarante-huit (48) heures. L’employ</p>
    </div>
    <div class="${lastIndex ? 'h-[590px]' : 'h-[591.4175px]'}  p-2">
      ...
      <div class="grid grid-cols-2 font-bold pl-4 py-2">
        ...
        <div class="col-span-1">Indemnité de Transport :</div>
        <div class="col-span-1">20 800 Fcfa</div>
        <div class="col-span-1">Salaire brut mensuel :</div>
        <div class="col-span-1">378 Frs CFA</div>
      </div>
      <p>
        Pour des nécessités de service, l’employé pourrait être amené à effectuer des heures
        supplémentaires. Dans cette éventualité les heures effectuées seront rémunérées conformément aux
        dispositions règlementaires en vigueur.
      </p>
      <h3 class="mt-2 font-bold">Article – 6 : Congés payés</h3>
      <p>
        La durée des congés payés de l’employé, l’allocation de congé ou l’indemnité compensatrice de congé
        en tenant lieu, seront respectées et acquittées conformément aux dispositions réglementaires en
        vigueur au Sénégal.
      </p>
      <h3 class="mt-2 font-bold">Article – 7 : Prévoyance Retraite- Maladie – Sécurité Sociale</h3>
      <p>
        Par les soins de l’employeur, l’Employé sera affilié auprès des Institutions en charge des régimes
        de retraite, de couverture médicale, de prestations familiales, d’accident de travail et des
        maladies professionnelles.
      </p>
      <h3 class="mt-2 font-bold">Article - 8: Exclusivité</h3>
      <p>
        ...
        concurrencer la Société ou de s’intéresser à des sociétés susceptibles de la concurrencer. Il lui
        est formellement interdit de percevoir toute autre forme de rétribution autre que la rémunération
        qui lui est payée par la Société.
      </p>
      <h3 class="mt-2 font-bold">Article - 9 : Confidentialité</h3>
      <p>
      ...
      <h3 class="mt-2 font-bold">Article - 10 : Respect des règles</h3>
      <p>
      ...
      <h3 class="mt-2 font-bold">Article - 11 : Règlement des différends et Litiges</h3>
      <p>
        Pour tout litige découlant de l’exécution, de contestation ou de l’interprétation du présent
        Contrat, les parties s’engagent à régler leur différend à l’amiable, avant toute saisine de
