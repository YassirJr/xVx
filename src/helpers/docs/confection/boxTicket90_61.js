export function getBoxTicket90_61({ confection, company }, isLastEl) {
  ...
  return [...new Array(nbr_boxes)].reduce((accum, _, index, array) => {
    ...
    return (
      accum +
      `<div class="flex justify-center items-center w-[340px]
      ${isLastEl && lastIndex ? 'h-[229px]' : 'h-[230.5511811px]'} p-2 text-[13px]">
